...
export class TabComponent implements OnInit {
  ...
  @ContentChild(TabHeaderComponent, {static: false}) public tabHeaderComponent: TabHeaderComponent;
  @ContentChild(TabContentComponent, {static: false}) public tabContentComponent: TabContentComponent;
